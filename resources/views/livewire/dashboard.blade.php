<x-layouts.app title="Painel — AgroLink MZ">
    ...
    <div class="mt-6 flex flex-wrap gap-3 text-sm">
        ...
        @if (in_array($user->role, ['operator', 'admin']))
            <a href="{{ route('admin.dashboard') }}" wire:navigate class="rounded border border-stone-200 px-3 py-2 hover:border-green-600 hover:text-green-700">Painel administrativo</a>
        @endif
